...
* ***harry_Potter_characters.txt*** is the file containing the list of all characters (we build it by mrewriting the names so that they exactly match the one used in the wiki fandom pages urls.
* ***characters_with_citation_counts*** same as the above file but with the number of citations for each characters added on their repsective lines

## /wikitext_files folder
This folder contains the wikitext of the  wiki fandom pages associated to each of our node's related character.
